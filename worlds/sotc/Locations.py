...
location_tables = {
    "Traversal": [
        ...
        SotcLocationData("Climbing Distance: 1000", "Sliver of Hope (HP)", SotcLocationCategory.CLIMB_DISTANCE),
    ],
    "Grid C1": [
    ...
    "Grid G7": [
        ...
        SotcLocationData("G7 - Shrine", "Sliver of Hope (HP)", SotcLocationCategory.SHRINE),
    ],
    "Grid H7": [
